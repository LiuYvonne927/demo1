...
header_label = tk.Label(window,text='BMI 計算器',bg='white')
header_label.pack()

height_frame = tk.Frame(window)
height_frame.pack(side=tk.TOP)
height_label = tk.Label(height_frame,text='身高(m)',bg='white')
...
weight_label = tk.Label(weight_frame,text='體重(kg)',bg='white')
